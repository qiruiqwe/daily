...
<body>
    ...
    <div id="main">
        <div id="lside">
            <article>
            	<form id="itemForm" action="${pageContext.request.contextPath }/editDiary.action" method="post" enctype="multipart/form-data">
				<input type="hidden" name="id" value="${diary.id }"/>
				<h1 align="center">修改日记</h1>
			<table width="100%" border=1>
<tr>
	<td>日记日期</td>
	<td><input type="text" name="createtime" value="${diary.createtime }"/></td>
</tr>
<tr>
	<td>标题</td>
...
<tr>
	<td>图片</td>
	<td><input type="text" name="pic" value="${diary.pic }"/></td>
</tr>
<tr>
	<td>内容</td>
	<td>
	<textarea rows="6" cols="106" name="content">${diary.content }</textarea>
	</td>
</tr>
<tr>
